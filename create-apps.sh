...
node unitejs/unitejs-cli/bin/unite configure --packageName=preact-javascript-systemjs --title="Preact JavaScript SYstemJS" --profile=PreactJavaScript --moduleType=SystemJS --bundler=SystemJSBuilder --outputDirectory=./apps/preact-javascript-systemjs
